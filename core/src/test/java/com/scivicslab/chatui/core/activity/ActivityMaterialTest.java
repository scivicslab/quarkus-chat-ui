...
/**
 * Pure unit test for the material {@link ActivityWork} hands the model.
 *
...
class ActivityMaterialTest {
    ...
    void material_labelsWhoSaidWhat() {
        String out = ActivityWork.material(List.of(
    ...
    void clip_collapsesWhitespaceSoOneEntryStaysOneLine() {
        assertEquals("a b c", ActivityWork.clip("a\n  b\tc"));
    }
    ...
    void clip_cutsALongAnswerToItsOpening() {
        ...
        String clipped = ActivityWork.clip(long_);
    ...
    void clip_ofNothing_isEmpty() {
        assertEquals("", ActivityWork.clip(null));
    }
}
